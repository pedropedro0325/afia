...
const Paiement = () => {
  ...
  const care = dataI?.event?.care?.id

  const act = dataI?.event?.care?.acts?.map((el: any) => (el.id))
            ...
            <form onSubmit={onSubmit}>
              <div className='partiel'>
                <div className='partiel1'>
                  <h4>Motif</h4>
                  <input type="text" name="careId" onChange={onChange} placeholder={`${care}`} required />
                  <h4>Acte</h4>
                ...
                <div className='partiel1'>
                  ...
                  <input type="date" name="dateAmount" onChange={onChange} placeholder='' required />
                  <h4>Payer par </h4>
